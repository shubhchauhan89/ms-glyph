...
if (isset ($_POST['add'])) {
    ...
    if ($_FILES['lis_img']['name'] != '') {
        ...
        $folder = "assets/images/blog-cat/" . $lis_img;
                            ...
                            <div class="row form-material">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="cat_name"
                                        value="<?php echo htmlspecialchars($roww["cat_name"]); ?>" class="form-control"
                                        placeholder="Enter Category Name" id="mdate">
                                    <h6 class="input-title">Category Url</h6>
                                    <input type="text" name="cat_url"
                                        value="<?php echo htmlspecialchars($roww["cat_url"]); ?>" id="date-format"
                                        class="form-control" placeholder="Enter Category Url">
                                </div>
                                <div class="card-body">
                                    <p>Upload Image</p>
                                    <input type="file" name="lis_img" id="input-file-now" class="dropify">
                                    <p><?php echo $roww["img"]; ?></p>
                                </div>
                            ...
                            <tbody>
                                ...
                                while ($location_ft = mysqli_fetch_array($location)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/blog-cat/<?php echo $location_ft["img"]; ?>"
                                                width="50px" /></td>
                                        <td>
                                            <a href="add-blog-category.php?edit=<?php echo $location_ft["id"]; ?>" onclick="return confirm('Are you sure?')"
                                                class="btn btn-success waves-effect waves-light text-white">Edit</a>
                                        </td>
                                        <td>
                                            <a href="add-blog-category.php?delete_id=<?php echo $location_ft["id"]; ?>" onclick="return confirm('Are you sure?')"
