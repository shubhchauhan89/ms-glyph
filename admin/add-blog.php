                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row form-material">
                                <div class="col-md-6">
                                    <h6 class="input-title mt-0">Blog Name</h6>
                                    <input type="text" name="title" value="<?php echo $roww["title"]; ?>"
                                        class="form-control" placeholder="Enter Blog Name" id="mdate">
                                    <h6 class="input-title">Blog Url</h6>
                                    <input type="text" name="url" value="<?php echo $roww["url"]; ?>" id="date-format"
                                        class="form-control" placeholder="Enter Blog Url">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-lg-6 card-body">
                                    ...
                                    <select name="category" class="form-control">
                                        ...
                                        while ($location_ft = mysqli_fetch_array($location)) {
                                            ?>
                                            <option <?php
                                            if ($roww["category"] == $location_ft["cat_name"]) {
                                                echo 'selected';
                                            }
                                            ?> value="<?php echo $location_ft["cat_url"]; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                    if (!empty($roww["img"])) {
                                        echo '<img src="assets/images/blog/' . $roww["img"] . '" alt="Uploaded Image" style="max-width: 10%; height: auto;">';
                                    }
                                    ?>
                                </div>
