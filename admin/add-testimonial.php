...
if ($edit != '') {
    $stmt = $con->prepare("SELECT * FROM testimonials WHERE id=?");
...
if (isset ($_POST['add'])) {
    ...
    if ($_FILES['lis_img']['name'] != '') {
        ...
        $folder = "assets/images/testimonial/" . $lis_img;
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row form-material">
                                <div class="col-md-12">
                                    <h6 class="input-title mt-0">Title</h6>
                                    <input type="text" name="title"
                                        value="<?php echo htmlspecialchars($roww["title"]); ?>" class="form-control"
                                        placeholder="Enter title" id="mdate">
                                    <h6 class="input-title">Degination</h6>
                                    <input type="text" name="designation"
                                        value="<?php echo htmlspecialchars($roww["designation"]); ?>" id="date-format"
                                        class="form-control" placeholder="Enter designation">
                                    <h6 class="input-title">Description</h6>
                                    <textarea name="descrip" class="summernote"><?php echo htmlspecialchars($roww["descrip"]); ?></textarea>
                                </div>
                                <div class="card-body">
                                    <p>Upload Image</p>
                            ...
                            <tbody>
                                ...
                                while ($location_ft = mysqli_fetch_array($location)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/testimonial/<?php echo $location_ft["img"]; ?>"
                                                width="50px" /></td>
                                        <td>
                                            <a href="add-testimonial.php?edit=<?php echo $location_ft["id"]; ?>"
                                                onclick="return confirm('Are you sure?')"
                                                class="btn btn-success waves-effect waves-light text-white">Edit</a>
                                        </td>
                                        <td>
                                            <a href="add-testimonial.php?delete_id=<?php echo $location_ft["id"]; ?>"
                                                onclick="return confirm('Are you sure?')"
