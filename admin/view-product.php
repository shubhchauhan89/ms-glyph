...
if (isset($_POST['delete'])) {
    ...
    foreach ($ids as $id) {
        ...
        if (mysqli_num_rows($selectdelete) > 0) {
            ...
            $stmt->close();
            $del_stmt = $con->prepare("DELETE FROM product WHERE id=?");
    ...
    if ($p) {
        ...
        echo "<script>alert('Error occurred while deleting products');</script>";
    }
    echo "<script>window.location.href = 'view-product.php'</script>";
}

$resultt = mysqli_query($con, "SELECT * FROM product ORDER BY id DESC");
?>
                                    ...
                                    while ($roww = mysqli_fetch_array($resultt)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img style="width:50px;"
                                                    src="assets/images/product/<?php echo $roww["img"]; ?>"></td>
                                            <td>
                                                <?php echo $roww["title"]; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td><a href="add-product.php?edit=<?php echo $roww["id"]; ?>"
                                                    class="btn btn-success waves-effect waves-light text-white">Edit</a>
                                            </td>
                                            <td><a href="view-product.php?delete_id=<?php echo $roww["id"]; ?>"
